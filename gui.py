...
class Home(Frame):
	...
	def __init__(self,parent,controller):
		...
		button5=Button(self,text="Seller info",command=lambda:controller.show_frame(Seller_info))
		button6=Button(self,text="Add Orders",command=lambda:controller.show_frame(Add_Orders))
...
class Add_Products(Frame):
	...
	def __init__(self,parent,controller):
		...
		self.tree.grid(row=2, column=1 ,padx=10,pady=10,columnspan=4, sticky='nsew')
		self.tree['show']='headings'
...
class Add_Employees(Frame):
	...
	def __init__(self,parent,controller):
		...
		self.emp_gender=Text(self,height=1,width=30)
